    ...
    <div>
              ...
              {loading ? (
                ...
                notes.map((n, idx) => (
                  <tr key={n.id}>
                    ...
                    <td>{n.title}</td>
                    <td>{getProjectName(n.project, lang)}</td>
                    <td>
                    ...
                    <td>
                      <div className="td-actions">
                        <button
                          ...
                          title={t("view")}
                          onClick={() => navigate(`/fieldNotes/${n.id}`)}
                        >
                          👁️
                        </button>
                        {isManager() && (
      ...
      >
        <form id="modal-form" onSubmit={handleSubmit}>
          ...
          <div className="form-group">
            <label className="form-label">{t("noteTitle")} *</label>
            <input
              className="form-control"
          ...
          <div className="form-group">
            <label className="form-label">{t("noteDescription")}</label>
            <textarea
              className="form-control"
